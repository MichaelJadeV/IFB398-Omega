...
Welcome_Message.grid(row = 0, column = 1,padx = 135, pady = 10)
Message2.grid(row = 1, column = 1, pady = 15)
btn_change.grid(row = 2, column = 1, padx = 50, sticky = W)
btn_2.grid(row = 2, column = 1,padx = 50, sticky = E)
...
btn_A = Button(Frame2, text="Type A",font=('Helvetica',10), bg= '#D9D9D9', fg='#000000', command = TypeA)
btn_B = Button(Frame2, text="Type B",font=('Helvetica',10), bg= '#D9D9D9', fg='#000000', command = TypeB)
btn_C = Button(Frame2, text="Type C",font=('Helvetica',10), bg= '#D9D9D9', fg='#000000', command = TypeC)
#Filename Labels
lbl_heading = Label(Frame2,text='Filename:',bg= '#FFFFFF', font=("Helvetica", 16))
name = Entry(Frame2, bg= '#D9D9D9', width = 20 )
name.insert(0, format)
...
lbl_heading.grid(row = 2, column = 1, sticky = W, padx = 150, pady = 15)
name.grid(row = 2, column = 1, sticky = E, padx = 150, pady = 15)
